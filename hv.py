...
class HyperVolume:
    ...
    def compute(self, front, normalized = True):
        ...
        for point in front:
            if normalized:
                if weaklyDominates(point.normalized_fitness, referencePoint):
                    relevantPoints.append(point.normalized_fitness)
            else:
                if weaklyDominates(point.fitness, referencePoint):
                    relevantPoints.append(point.fitness)
